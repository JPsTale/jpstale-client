...
ok('WorldViewOpts 声明 onCastSkill 回调（含 animIndex/animClip：跨端同步"播了哪一条"）',
  /onCastSkill\?: \(skillId: number, targetId: number, animIndex\?: number, animClip\?: string\) => void/.test(wv));
