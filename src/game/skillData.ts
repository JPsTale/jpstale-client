...
export interface SkillDef {
   ...
   *
   * 我方现状：`RIGHT` 166 / `ALL` 27 / `NOT` 27 / **`LEFT` 0**（本表暂未用到 `LEFT`）。
   *
   * ⚠ **权威 = 源码 `USECODE`**（2026-09-23 裁定）：160 个有源码的格**逐格等于**生成物的
   * `sourceUseCode`（`npm run verify-skill-usecode` 钉住）；60 个无源码的格用本表客户端值。
   */
...
export const SKILLS: Record<string, SkillDef[]> = {
  ...
  atalanta: [
    ...
    { iconFile: 'ma12 farina.bmp', name: 'Farina', reqLv: 12, type: 'Single Target', useCode: 'ALL', weapon: [9], desc: 'Throws a spear that creates illusions Farina does +50% Damage against normal monsters.' },
    { iconFile: 'ma14 t_mastery.bmp', name: 'Throwing Mastery', reqLv: 14, type: 'Passive', useCode: 'NOT', weapon: [9], desc: 'Trains Javelin attacks to increase damage permanently using Javelins' },
    ...
    { iconFile: 'ma20 windy.bmp', name: 'Windy', reqLv: 20, type: 'Buff', useCode: 'RIGHT', weapon: [9], desc: 'Increases attack rating of Javelins' },
    { iconFile: 'ma23 t_javelin.bmp', name: 'Twist Javelin', reqLv: 23, type: 'Single Target', useCode: 'RIGHT', weapon: [9], desc: 'Increase attack rating and attack power with using a twisting tactic Twist Javelin does +100% Damage against demon monsters.' },
    ...
    { iconFile: 'ma30 f_javelin.bmp', name: 'Fire Javelin', reqLv: 30, type: 'Single Target', useCode: 'ALL', weapon: [9], desc: 'Attacks the enemy with power of fire Fire Javelin does +100% Damage against mutant monsters. Fire Javelin does Fire damage.' },
    ...
    { iconFile: 'ma43 t_of_valhalla.bmp', name: 'Triumph of Valhalla', reqLv: 43, type: 'Buff', useCode: 'RIGHT', weapon: [9], desc: 'Increases attack power of all party members Triumph of Valhalla cast onto other players give 50% of the added Max Attack Power based on the caster\'s level.' },
    { iconFile: 'ma46 l_javelin.bmp', name: 'Lightning Javelin', reqLv: 46, type: 'Target Area', useCode: 'ALL', weapon: [9], desc: 'Increases the lightning attribute of the Javelin Piercing does +50% Damage against undead monsters. Storm Javelin will always hit its targets. Lightning Javelin does Lightning Damage' },
    ...
    { iconFile: 'ma60 h_o_valhalla.bmp', name: 'Hall of Valhalla', reqLv: 60, type: 'Buff', useCode: 'RIGHT', weapon: [9], desc: 'Creates a space to unleash the Power of Valhalla Hall of Valhalla chains Triumph of Valhalla\'s Max. Attack Power by 100% Hall of Valhalla Evasion is reduced by 50% to party members. Hall of Valhalla can evade area damage.' },
  ...
  knight: [
    { iconFile: 'mn10 s_blast.bmp', name: 'Sword Blast', reqLv: 10, type: 'Target Area', useCode: 'ALL', weapon: [6], desc: 'Throws a devastating blast towards the targeted enemy damaging enemies in its path Sword Blast does +50% Damage Boost against normal and mutant monsters. Sword Blast will always hit its targets. Sword Blast does linear area damage.' },
    ...
    { iconFile: 'mn14 p_traning.bmp', name: 'Physical Training', reqLv: 14, type: 'Passive', useCode: 'NOT', weapon: [], desc: 'Physical Training increases stamina permanently' },
    ...
    { iconFile: 'mn20 h_valor.bmp', name: 'Holy Valor', reqLv: 20, type: 'Buff', useCode: 'RIGHT', weapon: [], desc: 'Increases attack power of the party against the Undead Cannot be used simultaneously with Drastic Spirit. Damage Boost does not apply to AoE damage.' },
    ...
    { iconFile: 'mn26 piercing.bmp', name: 'Piercing', reqLv: 26, type: 'Target Area', useCode: 'ALL', weapon: [6], desc: 'Pierces a sword through the targeted enemy with a powerful attack Piercing does +100% Damage against mutant monsters. Piercing will always hit its targets. Piercing does linear area damage.' },
    { iconFile: 'mn30 d_spirit.bmp', name: 'Drastic Spirit', reqLv: 30, type: 'Buff', useCode: 'RIGHT', weapon: [], desc: 'Increases defense rating Cannot be used simultaneously with Holy Valor.' },
    { iconFile: 'mn40 s_mastery.bmp', name: 'Sword Mastery', reqLv: 40, type: 'Passive', useCode: 'NOT', weapon: [6], desc: 'Increases attack power on swords permanently' },
    ...
    { iconFile: 'mn46 h_incantation.bmp', name: 'Holy Incantation', reqLv: 46, type: 'Active', useCode: 'RIGHT', weapon: [], desc: 'Transforms the targeted monster into a pet that will fight for you in battle for a period of time' },
  ...
  magician: [
    ...
    { iconFile: 'mm12 firebolt.bmp', name: 'Fire Bolt', reqLv: 12, type: 'Single Target', useCode: 'ALL', weapon: [2], desc: 'Shoot a Fire Bolt Fire Bolt does fire damage.' },
    ...
    { iconFile: 'mm17 fireball.bmp', name: 'Fire Ball', reqLv: 17, type: 'Target Area', useCode: 'RIGHT', weapon: [2], desc: 'Fires a huge Fire Ball towards the enemy damaging all surroundings Fire Ball will always hit its target. Fire Ball does fire damage.' },
    { iconFile: 'mm20 m_mastery.bmp', name: 'Mental Mastery', reqLv: 20, type: 'Passive', useCode: 'NOT', weapon: [], desc: 'Permanently increase maximum MP' },
    ...
    { iconFile: 'mm26 e_weapon.bmp', name: 'Enchant Weapon', reqLv: 26, type: 'Buff', useCode: 'RIGHT', weapon: [2], desc: 'Enhances Attack Power with the Fire, Ice or Lightning Element Enchant Weapon randomly selects the elemental property. Affects the final damage inflicted on a target, after all modifiers.' },
    { iconFile: 'mm30 d_ray.bmp', name: 'Death Ray', reqLv: 30, type: 'Single Target', useCode: 'ALL', alt: 'Dead Ray', weapon: [2], desc: 'Fires a powerful ray from palms' },
    ...
    { iconFile: 'mm43 diastrophism.bmp', name: 'Diastrophism', reqLv: 43, type: 'Area Attack', useCode: 'RIGHT', weapon: [2], desc: 'Strong geographical attack to opponents within range Diastrophism will always hit its targets. Diastrophism does 2 hits.' },
  ...
  priestess: [
    ...
    { iconFile: 'mp12 holybolt.bmp', name: 'Holy Bolt', reqLv: 12, type: 'Single Target', useCode: 'ALL', weapon: [2], desc: 'Attacks the enemy with a holy bolt Holy bolt does +100% Damage against undead monsters.' },
    ...
    { iconFile: 'mp17 holymind.bmp', name: 'Holy Mind', reqLv: 17, type: 'Active', useCode: 'RIGHT', weapon: [2], desc: 'Weakens the enemy attack power for a small period of time' },
    { iconFile: 'mp20 meditation.bmp', name: 'Meditation', reqLv: 20, type: 'Passive', useCode: 'NOT', weapon: [], desc: 'Increases MP Recovery permanently' },
    ...
    { iconFile: 'mp26 h_reflection.bmp', name: 'Holy Reflection', reqLv: 26, type: 'Buff', useCode: 'RIGHT', weapon: [2], desc: 'Reflects attacks from Undead enemies Holy Reflection is automatically disabled if Priestess is not active.' },
    ...
    { iconFile: 'mp40 v_ball.bmp', name: 'Vigor Ball', reqLv: 40, type: 'Single Target', useCode: 'ALL', weapon: [2], desc: 'Fires two Vigor Balls towards the enemy Vigor Ball does +80% Damage against undead monsters. Does 2 hits.' },
    ...
    { iconFile: 'mp46 extinction.bmp', name: 'Extinction', reqLv: 46, type: 'Active', useCode: 'RIGHT', weapon: [2], desc: 'Lethal incantation to undead monsters' },
  ...
  assassin: [
    ...
    { iconFile: 'ta20 v_throne.bmp', name: 'Venom Thorn', reqLv: 20, type: 'Single Target', useCode: 'RIGHT', alt: 'Venom Throne', weapon: [10], desc: 'Attacks the enemy twice rapidly with poisoned daggers Venom Thorn does 2 hits. Venom Thorn does poison damage.' },
    ...
    { iconFile: 'ta40 s_sword.bmp', name: 'Finishing Blow', reqLv: 40, type: 'Single Target', useCode: 'RIGHT', alt: 'Sore Sword', weapon: [10], desc: 'Deals repeated damage to the enemy Finish Blow does 2 hits.' },
  ...
  shaman: [
    ...
    { iconFile: 'ms14 curselazy.bmp', name: 'Inertia', reqLv: 14, type: 'Active', useCode: 'RIGHT', alt: 'Curse Lazy', weapon: [11], desc: 'Throws a curse onto the enemy to slow down the enemy' },
    { iconFile: 'ms17 i_peace.bmp', name: 'Inner Peace', reqLv: 17, type: 'Passive', useCode: 'NOT', weapon: [], desc: 'Through mental training your maximum Mana capacity is increased permanently' },
    ...
    { iconFile: 'ms23 s_manacle.bmp', name: 'Spiritual Manacle', reqLv: 23, type: 'Active', useCode: 'RIGHT', alt: 'Soul Manacle', weapon: [11], desc: 'Binds the target\'s soul with sorcery that results in a stun of the target' },
    ...
    { iconFile: 'ms63 judge.bmp', name: 'Judgement', reqLv: 63, type: 'Single Target', useCode: 'ALL', weapon: [11], desc: 'Deals a large portion of damage by shooting a powerful energy beam of darkness at the enemy Judgment does +50% Damage against demon monsters.' },
