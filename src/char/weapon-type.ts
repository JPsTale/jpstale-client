 ...
 * @param idCode 武器 idcode（如 0x01060100）
 * @returns 'AXE'|'CLAW'|'HAMMER'|'STAFF'|'SCYTHE'|'BOW'|'CROSSBOW'|'SWORD'|'JAVELIN'|'DAGGER'|null
 */
